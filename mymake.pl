...
if(!$opts{disable_fortran}){
    ...
    push @extra_make_rules, "src/binding/fortran/use_mpi_f08/wrappers_f/%.lo : src/binding/fortran/use_mpi_f08/mpi_f08.lo src/binding/fortran/use_mpi_f08/mpi_c_interface.lo src/binding/fortran/use_mpi_f08/mpi_c_interface.lo", "";
